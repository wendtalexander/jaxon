---
title: "Adaptive Leaky Integrated-and-Fire-Model with refractory period (aLIF_ref)"
format:
  html:
    toc: true
    css: styles.css
...
$$ \tau_{m}\frac{dv}{dt} = -u(t)+ \mu + -A(t) + \sqrt{2D}\xi(t) $$
...
import jaxon.models.alif_ref as alif
