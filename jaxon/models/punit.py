...
def simulate(key: ArrayLike, stimulus: ArrayLike, params: PUnitParams) -> SIMOutput:
    """Simulate a P-unit.
    ...
    def step(carry, x):
        ...
        final_adapt = jnp.where(spike_fired, adapt_new + params.delta_a / params.tau_a, adapt_new)
